...
import com.qihoo.yueba.ui.activities.AddEventActivity;
import com.qihoo.yueba.ui.activities.FriendListActivity;
import com.qihoo.yueba.ui.activities.PublicActivity;
import com.qihoo.yueba.ui.activities.SettingActivity;
...
public class Desktop {
		...
		mDisplay.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 0) {
					...
					case 1:
						Toast.makeText(mContext, "Ê©¹¤ÖÐ¡£¡£¡£*^_^*",
	...
	private void init_Data() {
		...
		mChildFavoriteIcon[1] = R.drawable.v5_0_1_desktop_list_page;
		mChildFavoriteIcon[2] = R.drawable.v5_0_1_desktop_list_friends;
		mChildFavoriteIcon[3] = R.drawable.v5_0_1_desktop_list_chat;
